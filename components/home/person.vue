					...
					<div class="col-span-1 w-full max-w-sm bg-stone-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-2 mb-6 md:h-[85vh] h-auto">
						<div class="flex flex-col items-center pb-10">
							...
							<div class="flex mt-4 md:mt-6">
								<a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">See About Me &nbsp;&nbsp; <font-awesome-icon icon="px-2 fa-solid fa-arrow-right-from-bracket" /></a>
						...
						<div class="flex justify-center space-x-2 items-center pb-10">
							<a href="#" class="py-2 px-4 ms-2 md:text-sm text-lg font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"><font-awesome-icon icon="px-2 fa-brands fa-linkedin" /> <span class="md:block hidden">Linkedin</span></a>
